"""
Script to plot the outputs of GCAE analysis
"""
...
parser.add_argument('-d', '--which_dim', default='1,2', help='comma-separated list of PCs')
...
# Plot
print ('GCAE' + str(p) + ' ' for p in which_dim)
...
GCAE1vs2_panel= Panel(child=plot, title="GCAE"+str(which_dim[0])+" vs "+"GCAE"+str(which_dim[1]))

# Assign the panels to Tabs
tabs= Tabs(tabs=[GCAE1vs2_panel])
