...
# Usage: 
# python2 bokeh_pca_plot_PC1toPC10.py -i PCA_${DB}/${DB}.pca.evec -o ${DB} --title '' --which_pcs 1,2 -p PCA_${DB}/pattern.csv
#
...
plot = figure(title=title, toolbar_location="above", x_axis_label="PC"+str(which_pcs[0]), y_axis_label="PC"+str(which_pcs[1]), plot_width= width, plot_height= 1000, 
...
# Create panels
PC1vs3_panel = Panel(child=plot, title="PC"+str(which_pcs[0])+" vs "+"PC"+str(which_pcs[1]))
...
# Create panels
PC3vs4_panel = Panel(child=plot, title="PC"+str(which_pcs[0])+" vs "+"PC"+str(which_pcs[1]))
...
# Create panels
PC5vs6_panel = Panel(child=plot, title="PC"+str(which_pcs[0])+" vs "+"PC"+str(which_pcs[1]))
...
# Create panels
PC7vs8_panel = Panel(child=plot, title="PC"+str(which_pcs[0])+" vs "+"PC"+str(which_pcs[1]))
...
# Create panels
PC9vs10_panel = Panel(child=plot, title="PC"+str(which_pcs[0])+" vs "+"PC"+str(which_pcs[1]))

# Assign the panels to Tabs
tabs = Tabs(tabs=[PC1vs2_panel, PC1vs3_panel, PC3vs4_panel, PC5vs6_panel, PC7vs8_panel, PC9vs10_panel])
